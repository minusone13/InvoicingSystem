...
public class GiftBillVO extends VO
{
	...
	public GiftBillVO(String userID, String ID, ArrayList<CommodityVO> coms,
			String[] remark)
	{
	...
	public GiftBillVO(Date date, String userID, String ID,
			ArrayList<CommodityVO> coms, String[] remark, BillState state)
	{
		this.date = date;
		this.operator = userID;
		this.ID = ID;
